...
export const SERVICE_PLANS: Plan[] = [
  {
    ...
    buttonText: 'Iniciar Aceleração',
    buttonAction: 'start-online',
    icon: Zap,
    badge: 'Autoridade Instantânea',
    savings: 'Entrega em 48-72h (Velocidade IA)',
  ...
  },
  {
    ...
    price: 7500,
    period: 'MZN',
    description: 'O funil completo para encher o seu WhatsApp de clientes qualificados. Tracção real e imediata.',
    features: [
      'Tudo do Plano Accelera™ Branding',
      'Landing Page de Alta Conversão',
      'Arquitetura Mobile-First Impecável',
      '10 Criativos Estratégicos de Vendas',
      'Setup de Meta Ads (Facebook/IG)',
      'Funil de Captação Automatizado',
      'Estratégia de Tráfego de Alta Performance'
    ],
    highlighted: true,
    ...
    buttonText: 'Ligar o Motor',
    buttonAction: 'presenca-digital',
    icon: Rocket,
    badge: 'Máximo ROI',
    savings: 'Pronto para vender em 5-7 dias',
    deliveryTime: '5 a 7 dias úteis',
    focus: 'presence'
  },
  {
    name: 'IMPÉRIO DIGITAL 360™',
    price: 15000,
    period: 'MZN',
    description: 'Domine o seu setor. Um ecossistema completo de vendas, logística e tecnologia em piloto automático.',
    features: [
    ...
    buttonText: 'Construir Império',
    buttonAction: 'negocio-digital',
    icon: Store,
    badge: 'Escala Sem Limites',
    savings: 'Solução Completa e Robusta',
