  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="group flex items-center gap-2.5 px-4 py-2.5 bg-card/90 hover:bg-secondary/95 border border-white/10 hover:border-green-500/30 text-white rounded-full overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] backdrop-blur-xl hover:scale-105 active:scale-95 transition-all duration-300 ring-1 ring-white/5"
      >
