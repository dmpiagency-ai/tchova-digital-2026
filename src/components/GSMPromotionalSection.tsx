        ...
        >
          ...
          <div className="lg:col-span-5 relative h-64 xs:h-72 sm:h-80 lg:h-full lg:min-h-[340px] overflow-hidden">
            ...
            <div className="absolute top-3.5 left-3.5 sm:top-5 sm:left-5 z-10 flex gap-2">
              <div className="px-2.5 py-1 rounded-full bg-amber-500/20 backdrop-blur-md border border-amber-500/30 flex items-center gap-1.5">
                ...
                <span className="text-[9px] sm:text-[10px] font-bold text-amber-300 uppercase tracking-wider">Demo Preview</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 relative p-5 xs:p-6 sm:p-7 lg:p-9 flex flex-col justify-center z-10 mt-0">
            ...
            <div className="hidden sm:inline-flex items-center gap-1.5 sm:gap-2 mb-2 sm:mb-3 w-fit">
              ...
              <span className="text-[9px] sm:text-xs font-black uppercase tracking-[0.2em] text-amber-400">
                Infraestrutura GSM • Em Desenvolvimento
              </span>
            </div>
            ...
            <h2 className="text-xl xs:text-2xl sm:text-3xl lg:text-4xl font-black text-white uppercase tracking-tight leading-[0.95] mb-2.5 sm:mb-3">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-amber-300 to-primary/60">
                de Elite (Preview)
              </span>
            </h2>

            <p className="text-xs sm:text-sm text-zinc-400 mb-4 sm:mb-5 max-w-lg leading-relaxed font-medium">
              Explore o protótipo interativo do painel GSM com UnlockTool, Chimera, DFT Pro e Hydra em modo de demonstração restrita.
            </p>

            <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-4 sm:mb-6">
              {[
                { icon: Zap, title: 'Faturação', desc: 'Modo Simulação' },
                { icon: Server, title: 'Ativação', desc: 'Demonstração' },
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-5 mt-auto">
              <button className="flex items-center justify-center gap-2.5 w-full sm:w-auto bg-amber-400 text-black px-5 sm:px-7 py-3 sm:py-3.5 rounded-full font-bold text-xs sm:text-sm uppercase tracking-wide group-hover:scale-105 transition-all duration-300 shadow-lg shadow-amber-400/20">
                Explorar Demo Preview
                <ArrowRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 group-hover:translate-x-1 transition-transform" />
              </button>
              
              <div className="flex items-center justify-center gap-2.5 w-full sm:w-auto">
                <div className="flex -space-x-2">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full border-2 border-zinc-950 bg-amber-500/20 flex items-center justify-center text-amber-400">
                    <Server className="w-3.5 h-3.5" />
                  </div>
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full border-2 border-zinc-950 bg-primary/20 flex items-center justify-center text-primary">
                    <Cpu className="w-3.5 h-3.5" />
                  </div>
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full border-2 border-zinc-950 bg-amber-400 flex items-center justify-center text-black font-black text-[9px]">
                    GSM
                  </div>
                </div>
                <div className="flex flex-col">
                  <span className="text-[11px] sm:text-xs font-bold text-white leading-tight">Painel Técnico</span>
                  <span className="text-[9px] sm:text-[10px] text-zinc-500 leading-tight">Servidores Dedicados</span>
                </div>
              </div>
            </div>
