...
const TESTIMONIALS = [
  {
    ...
    company: 'Retalho de Moda (Maputo)',
    role: 'Proprietário',
    content: 'Em 2 semanas, a Tchova redesenhou toda a nossa imagem. Os clientes passaram a perguntar menos sobre preço e mais sobre como contratar.',
    rating: 5,
    avatar: miguelImg,
  },
  {
    id: 2,
    name: 'Sofia Costa',
    company: 'Serviços de Beleza',
    role: 'Fundadora',
    content: 'Antes perdia 3h/dia a responder no WhatsApp. Com o site e o sistema integrado, as encomendas chegam organizadas e o meu tempo voltou.',
    rating: 5,
    avatar: sofiaImg,
  },
  {
    id: 3,
    name: 'Hélder S.',
    company: 'Assistência Mobile',
    role: 'Técnico GSM Certificado',
    content: 'O painel GSM tornou o meu laboratório 2x mais rápido. Acesso estável, sem downtime, e suporte quando preciso.',
    rating: 5,
    avatar: helderImg,
  }
];
