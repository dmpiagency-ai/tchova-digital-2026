...
const TESTIMONIALS = [
  {
    ...
    role: 'CEO',
    content: 'Digitalizámos 100% do nosso funil de aquisição de clientes em Moçambique. O nosso volume de importações escalou 43% nos primeiros 90 dias com a nova infraestrutura técnica da TchovaDigital.',
    rating: 5,
  ...
  },
  {
    ...
    role: 'Fundadora',
    content: 'O reposicionamento de marca foi brutal. Conseguiram estabelecer a nossa autoridade de luxo instantaneamente. O suporte operacional é extremamente veloz e sem qualquer atrito.',
    rating: 5,
  ...
  },
  {
    ...
    role: 'Diretor Geral',
    content: 'A integração do painel GSM para controlo de reparações reduziu o tempo médio de atendimento ao cliente em 35%. Uma engenharia robusta que gera retorno real sobre o investimento.',
    rating: 5,
...
export const Testimonials = () => {
  ...
  return (
    <section id="testimonials" ref={containerRef} className="py-12 md:py-24 relative overflow-hidden bg-background/95 border-t border-white/5 perspective-1000">
                ...
                <div key={testimonial.id} className="flex-[0_0_100%] min-w-0">
                  <div
                    className={`relative border rounded-2xl overflow-hidden p-6 flex flex-col transition-all duration-400 ${
                      index === selectedIndex
                        ? 'bg-black/60 border-primary/25 shadow-[0_0_30px_-10px_rgba(34,197,94,0.3)]'
