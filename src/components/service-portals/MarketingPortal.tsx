            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <div className="p-6 sm:p-8 rounded-[2rem] sm:rounded-[3rem] bg-white/[0.02] backdrop-blur-xl border border-white/10 hover:bg-white/[0.04] transition-colors shadow-xl flex flex-col h-full group">
                <div className="space-y-4">
                  <span className="inline-block px-3 py-1.5 rounded-full bg-zinc-950 text-primary text-[8px] sm:text-[9px] font-black uppercase tracking-widest border border-white/5">Anúncios (Meta & Google)</span>
              ...
              <div className="p-6 sm:p-8 rounded-[2rem] sm:rounded-[3rem] bg-zinc-900/50 border border-white/5 shadow-xl flex flex-col h-full group">
                <div className="space-y-4">
                  <span className="inline-block px-3 py-1.5 rounded-full bg-zinc-950 text-primary text-[8px] sm:text-[9px] font-black uppercase tracking-widest border border-white/5">Pesquisa Local</span>
