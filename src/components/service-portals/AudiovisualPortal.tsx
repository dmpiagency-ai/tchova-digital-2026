...
// Vídeo & Fotografia - Interactive Onboard
// ============================================
...
const problems = [
  "O meu conteúdo nas redes sociais passa despercebido",
  "As fotos que tiro no telemóvel não valorizam o meu produto",
  "A minha marca não transmite impacto ou emoção visual",
  "Não consigo explicar bem o que faço apenas com texto"
];

const packages = [
  { title: "Vídeo Promocional", desc: "Apresenta a tua empresa ou produto de forma dinâmica e inesquecível." },
  { title: "Fotografia de Produto", desc: "Imagens que aumentam o desejo de compra imediato." },
  { title: "Cobertura Visual", desc: "Registo profissional de eventos, instalações ou processo de trabalho." },
  { title: "Vídeos Curtos (Reels/TikTok)", desc: "Conteúdo rápido e focado em retenção para atrair seguidores." }
];
...
const AudiovisualPortal = () => {
  ...
  const getWhatsAppLink = () => {
    const text = selectedProblem 
      ? `Olá! Gostaria de conversar sobre Audiovisual. O meu maior desafio atualmente é: "${selectedProblem}". Podem ajudar-me a criar melhor conteúdo?`
      : `Olá! Gostaria de conversar sobre produção de vídeo e fotografia para a minha empresa. Podem ajudar?`;
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-white select-none font-sans flex flex-col relative overflow-x-hidden">
      ...
      <header className="fixed top-0 z-50 w-full border-b border-white/5 bg-[#030303]/80 backdrop-blur-md">
        <div className="container mx-auto px-6 h-16 md:h-20 flex items-center justify-between">
          <button 
            ...
            className="no-min-size flex items-center gap-2 text-zinc-400 hover:text-white transition-colors group text-sm font-semibold"
          >
            <ArrowLeft className="w-4 h-4 transition-transform group-hover:-translate-x-1" />
            <span>{step === 1 ? 'Voltar ao Início' : 'Passo Anterior'}</span>
          </button>
          <div className="h-8">
      ...
      {/* Main Content Area */}
      <main className="flex-1 flex flex-col justify-center pt-20 pb-12 md:pt-24 md:pb-20 relative">
            ...
            <div className={`w-full flex-shrink-0 px-1 transition-opacity duration-500 ${step === 2 ? 'opacity-100' : 'opacity-20 pointer-events-none'}`}>
              <div className="text-center mb-10 md:mb-14">
                ...
                <p className="text-xs sm:text-sm md:text-lg text-zinc-400 font-medium max-w-2xl mx-auto">
                  Vê como produzimos conteúdo cinematográfico de alta qualidade para capturar a atenção de clientes.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-5xl mx-auto items-center">
                ...
                <div className="lg:col-span-6 relative rounded-3xl overflow-hidden aspect-[4/3] lg:aspect-square border border-white/10 group shadow-2xl">
                  <div 
                    ...
                    style={{ backgroundImage: `url('https://res.cloudinary.com/dwlfwnbt0/image/upload/f_auto,q_auto,w_800/v1762755464/1762703721009_w7posw.png')` }} 
                  />
                  ...
                  <div className="absolute bottom-6 left-6 p-4 rounded-2xl bg-black/60 backdrop-blur-md border border-primary/30 shadow-[0_0_20px_rgba(34,197,94,0.2)]">
                    ...
                    <span className="text-lg md:text-xl font-black text-white">+50K Visualizações Orgânicas</span>
                  </div>
                </div>
                ...
                <div className="lg:col-span-6 flex flex-col gap-5 text-left">
                  <div>
                    <span className="text-[9px] font-black text-primary uppercase tracking-widest mb-1 block">Estúdio Audiovisual • Mini Case</span>
                    <h3 className="text-xl md:text-2xl font-black uppercase text-white tracking-tight">Caso Zambi</h3>
                    <p className="text-[10px] md:text-xs text-zinc-400 font-bold uppercase tracking-wider mt-0.5">Produção de Vídeo & Sessão de Fotografia</p>
                  </div>
                  ...
                  <div className="space-y-3.5">
                    <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5">
                      ...
                      <p className="text-xs sm:text-sm text-zinc-300 leading-relaxed font-medium">
                        Fotografias amadoras tiradas por telemóvel no feed que não demonstravam a real sofisticação do ambiente e a qualidade gastronómica do restaurante.
                      </p>
                    </div>
                    ...
                    <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5">
                      ...
                      <p className="text-xs sm:text-sm text-zinc-300 leading-relaxed font-medium">
                        Produção de um vídeo institucional com iluminação cinematográfica, juntamente com uma sessão fotográfica focada em destacar a ementa de assinatura.
                      </p>
                    </div>
                    ...
                    <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5">
                      ...
                      <p className="text-xs sm:text-sm text-[#4ade80] leading-relaxed font-bold">
                        Mais de 50 mil visualizações orgânicas nas redes sociais na primeira semana e aumento notável no volume de reservas ao fim de semana.
                      </p>
                    </div>
                  </div>
                </div>
