  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <main className="container relative z-10 mx-auto px-4 pt-20 pb-6 max-w-5xl">
        ...
        {/* GSM Service Hero Section - Mobile First Bento Grid */}
        {isGSM ? (
          <div className="tech-card overflow-hidden mb-8 sm:mb-12 lg:mb-20 rounded-[24px] sm:rounded-[32px] lg:rounded-[48px] shadow-xl border border-primary/20 relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-brand-dark/10 to-brand-yellow/20">
            ...
            <div className="relative p-4 sm:p-6 lg:p-8">
              ...
              <div className="sm:hidden space-y-6">
                ...
                <div className="bg-brand-dark/95 backdrop-blur-lg rounded-[2rem] p-7 border-2 border-white/30 animate-fade-in shadow-2xl">
                  ...
                  <p className="text-base text-white/95 leading-relaxed font-medium">
                    Ferramentas profissionais para técnicos GSM com acesso a boxes e servers premium
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  >
                    <div className="w-[5.5rem] h-[5.5rem] bg-gradient-to-br from-primary to-primary-darker rounded-2xl flex items-center justify-center mb-5 shadow-2xl group-hover:scale-115 group-active:scale-90 transition-transform duration-150 ease-out will-change-transform">
                      <Box className="w-11 h-11 text-white drop-shadow-lg" />
                    </div>
                    <span className="text-lg font-extrabold text-gray-900 text-center tracking-tight">Chimera</span>
                    <span className="text-base text-gray-600 mt-1.5 font-medium">Tool</span>
                  </div>
                  ...
                  >
                    <div className="w-[5.5rem] h-[5.5rem] bg-gradient-to-br from-brand-green to-primary rounded-2xl flex items-center justify-center mb-5 shadow-2xl group-hover:scale-115 group-active:scale-90 transition-transform duration-150 ease-out will-change-transform">
                      <Lock className="w-11 h-11 text-white drop-shadow-lg" />
                    </div>
                    <span className="text-lg font-extrabold text-gray-900 text-center tracking-tight">Unlock</span>
                    <span className="text-base text-gray-600 mt-1.5 font-medium">Tool</span>
                  </div>
                  ...
                  >
                    <div className="w-[5.5rem] h-[5.5rem] bg-gradient-to-br from-brand-yellow to-accent-light rounded-2xl flex items-center justify-center mb-5 shadow-2xl group-hover:scale-115 group-active:scale-90 transition-transform duration-150 ease-out will-change-transform">
                      <Activity className="w-11 h-11 text-white drop-shadow-lg" />
                    </div>
                    <span className="text-lg font-extrabold text-gray-900 text-center tracking-tight">TCM</span>
                    <span className="text-base text-gray-600 mt-1.5 font-medium">Tool</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-lg font-extrabold text-gray-900 text-center tracking-tight">EFT</span>
                    <span className="text-base text-gray-600 mt-1.5 font-medium">Pro</span>
                  </div>
                  ...
                  >
                    <div className="w-[5.5rem] h-[5.5rem] bg-gradient-to-br from-primary to-brand-green rounded-2xl flex items-center justify-center mb-5 shadow-2xl group-hover:scale-115 group-active:scale-90 transition-transform duration-150 ease-out will-change-transform">
                      <RefreshCw className="w-11 h-11 text-white drop-shadow-lg" />
                    </div>
                    <span className="text-lg font-extrabold text-gray-900 text-center tracking-tight">Hydra</span>
                    <span className="text-base text-gray-600 mt-1.5 font-medium">Tool</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-lg font-extrabold text-gray-900 text-center tracking-tight">UMT</span>
                    <span className="text-base text-gray-600 mt-1.5 font-medium">Pro</span>
                  </div>
                </div>
                ...
                <Button
                  onClick={() => document.getElementById('servicos-gsm')?.scrollIntoView({ behavior: 'smooth' })}
                ...
                >
                  ...
                  <span className="relative z-10 tracking-tight">Ver Serviços GSM</span>
                </Button>
              </div>

              {/* Desktop Bento Grid (>= 640px) */}
              <div className="hidden sm:grid sm:grid-cols-4 sm:gap-4 lg:gap-6">
                {/* Left Column - Chimera Card (spans 2 rows) */}
                <div className="sm:row-span-2 bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl p-6 lg:p-8 flex flex-col items-center justify-center border border-primary/30 transform transition-all duration-300 hover:scale-[1.02] cursor-pointer group">
                  <div className="w-20 h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-primary to-primary-darker rounded-2xl flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300">
                    <Box className="w-10 h-10 lg:w-12 lg:h-12 text-white" />
                  </div>
                  <span className="text-base lg:text-lg font-bold text-gray-800 text-center">Chimera Tool</span>
                  <span className="text-sm text-gray-500 mt-1">Ferramenta Premium</span>
                </div>
                ...
                <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl p-5 lg:p-6 flex flex-col items-center justify-center border border-brand-green/30 transform transition-all duration-300 hover:scale-[1.02] cursor-pointer group">
                  ...
                  <span className="text-sm lg:text-base font-bold text-gray-800 text-center">UnlockTool</span>
                  <span className="text-xs text-gray-500 mt-0.5">Unlock</span>
                </div>
                ...
                <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl p-5 lg:p-6 flex flex-col items-center justify-center border border-brand-yellow/30 transform transition-all duration-300 hover:scale-[1.02] cursor-pointer group">
                  <div className="w-14 h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-brand-yellow to-accent-light rounded-xl flex items-center justify-center mb-3 shadow-lg group-hover:scale-110 transition-transform duration-300">
                    <Activity className="w-7 h-7 lg:w-8 lg:h-8 text-white" />
                  </div>
                  <span className="text-sm lg:text-base font-bold text-gray-800 text-center">TCM Tool</span>
                  <span className="text-xs text-gray-500 mt-0.5">Server</span>
                </div>
                ...
                <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl p-5 lg:p-6 flex flex-col items-center justify-center border border-brand-bright/30 transform transition-all duration-300 hover:scale-[1.02] cursor-pointer group">
                  ...
                  <span className="text-sm lg:text-base font-bold text-gray-800 text-center">EFT Pro</span>
                  <span className="text-xs text-gray-500 mt-0.5">Box</span>
                </div>
                ...
                <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl p-5 lg:p-6 flex flex-col items-center justify-center border border-primary/30 transform transition-all duration-300 hover:scale-[1.02] cursor-pointer group">
                  ...
                  <span className="text-sm lg:text-base font-bold text-gray-800 text-center">Hydra Tool</span>
                  <span className="text-xs text-gray-500 mt-0.5">Server</span>
                </div>
                ...
                <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl p-5 lg:p-6 flex flex-col items-center justify-center border border-brand-dark/30 transform transition-all duration-300 hover:scale-[1.02] cursor-pointer group">
                  ...
                  <span className="text-sm lg:text-base font-bold text-gray-800 text-center">UMT Pro</span>
                  <span className="text-xs text-gray-500 mt-0.5">Box</span>
                </div>
              </div>
              ...
              <div className="hidden sm:block mt-4 lg:mt-6">
                ...
                >
                  ...
                  <span className="relative z-10">Ver Serviços GSM</span>
                </Button>
              </div>
            </div>
          </div>
        ...
        {/* GSM Section - Mobile First */}
        {isGSM && (
          <>
            {/* Serviços GSM - Mobile First - UX Mega Ultra Otimizado */}
            <div id="servicos-gsm" className="liquid-card rounded-[24px] sm:rounded-[32px] lg:rounded-[48px] p-4 xs:p-6 sm:p-8 lg:p-12 mb-8 sm:mb-12 lg:mb-16 backdrop-blur-xl bg-white/5 dark:bg-black/5 border border-primary/20 shadow-2xl scroll-mt-20 sm:scroll-mt-24">
              <h2 className="text-lg xs:text-xl sm:text-2xl lg:text-3xl font-bold text-foreground mb-4 sm:mb-6 lg:mb-8 flex items-center">
                <Target className="text-2xl xs:text-3xl sm:text-4xl lg:text-6xl text-primary mr-2 sm:mr-3 lg:mr-4 flex-shrink-0" />
                <span className="bg-gradient-to-r from-primary to-brand-green bg-clip-text text-transparent font-black">Serviços GSM</span>
              </h2>
              
              {/* Mobile Grid - UX Mega Ultra Otimizado */}
              <div className="sm:hidden space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  {[
                    { name: 'FRP Reset', desc: 'Google', icon: <Lock className="w-11 h-11" />, gradient: 'from-primary to-primary-darker', border: 'border-primary/50' },
                    { name: 'IMEI Repair', desc: 'Reparação', icon: <Smartphone className="w-11 h-11" />, gradient: 'from-brand-green to-primary', border: 'border-brand-green/50' },
                    { name: 'Unlock', desc: 'Desbloqueio', icon: <LockKeyhole className="w-11 h-11" />, gradient: 'from-brand-yellow to-accent-light', border: 'border-brand-yellow/50' },
                    { name: 'Software', desc: 'Flash', icon: <RefreshCw className="w-11 h-11" />, gradient: 'from-brand-bright to-brand-green', border: 'border-brand-bright/50' },
                    { name: 'Reparos', desc: 'Técnica', icon: <Activity className="w-11 h-11" />, gradient: 'from-primary to-brand-green', border: 'border-primary/50' },
                    { name: 'Diagnóstico', desc: 'Análise', icon: <Search className="w-11 h-11" />, gradient: 'from-brand-dark to-brand-dark', border: 'border-brand-dark/50' }
                  ].map((service, index) => (
                    <div
                      key={index}
                      className={`bg-white/98 backdrop-blur-2xl rounded-[1.75rem] shadow-2xl p-7 flex flex-col items-center justify-center aspect-square border-[3px] ${service.border} transform transition-all duration-150 ease-out active:scale-[0.92] active:shadow-lg active:brightness-95 cursor-pointer animate-fade-in group touch-manipulation will-change-transform hover:shadow-primary/30 hover:shadow-[0_0_30px_rgba(var(--color-primary),0.3)]`}
                      style={{ animationDelay: `${0.1 + index * 0.05}s` }}
                    >
                      <div className={`w-[5.5rem] h-[5.5rem] bg-gradient-to-br ${service.gradient} rounded-2xl flex items-center justify-center mb-5 shadow-2xl group-hover:scale-115 group-active:scale-90 transition-transform duration-150 ease-out will-change-transform`}>
                        <span className="text-white drop-shadow-lg">{service.icon}</span>
                      </div>
                      <span className="text-lg font-extrabold text-gray-900 text-center tracking-tight">{service.name}</span>
                      <span className="text-base text-gray-600 mt-1.5 font-medium">{service.desc}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="hidden sm:grid sm:grid-cols-2 gap-4 lg:gap-6">
                {[
                  { name: 'FRP Reset', desc: 'Desbloqueio de conta Google', icon: <Lock className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7" />, gradient: 'from-primary to-primary-darker', color: 'from-primary/20 to-primary-darker/20 border-primary/30' },
                  { name: 'IMEI Repair', desc: 'Reparação de IMEI', icon: <Smartphone className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7" />, gradient: 'from-brand-green to-primary', color: 'from-brand-green/20 to-primary/20 border-brand-green/30' },
                  { name: 'Unlock', desc: 'Desbloqueio de rede', icon: <LockKeyhole className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7" />, gradient: 'from-brand-yellow to-accent-light', color: 'from-brand-yellow/20 to-accent-light/20 border-brand-yellow/30' },
                  { name: 'Software', desc: 'Flash e firmware', icon: <RefreshCw className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7" />, gradient: 'from-brand-bright to-brand-green', color: 'from-brand-bright/20 to-brand-green/20 border-brand-bright/30' },
                  { name: 'Reparos', desc: 'Reparação técnica', icon: <Activity className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7" />, gradient: 'from-primary to-brand-green', color: 'from-primary/20 to-brand-green/20 border-primary/30' },
                  { name: 'Diagnóstico', desc: 'Análise completa', icon: <Search className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7" />, gradient: 'from-brand-dark to-brand-dark', color: 'from-brand-dark/20 to-brand-dark/20 border-brand-dark/30' }
                ].map((service, index) => (
                  <div
                    key={index}
                    className={`group bg-gradient-to-br ${service.color} backdrop-blur-lg rounded-[16px] sm:rounded-[20px] lg:rounded-[24px] p-4 sm:p-5 lg:p-6 border hover:scale-[1.02] transition-all duration-500`}
                  >
                    <div className={`flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-gradient-to-br ${service.gradient} rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 text-white mb-3`}>
                      {service.icon}
                    </div>
                    <h3 className="font-bold text-xs sm:text-sm lg:text-base leading-tight text-foreground mb-1">{service.name}</h3>
                    <p className="text-[10px] sm:text-xs lg:text-sm text-muted-foreground leading-tight">{service.desc}</p>
                  </div>
                ))}
              </div>
              
              <p className="text-center text-muted-foreground text-xs sm:text-sm lg:text-base mt-4 sm:mt-6 lg:mt-8">
                Serviços variam conforme marca e modelo do dispositivo.
              </p>
            </div>

            {/* Processo - 5 Etapas - Mobile First - UX Mega Ultra Otimizado */}
            <div className="liquid-card rounded-[24px] sm:rounded-[32px] lg:rounded-[48px] p-4 xs:p-6 sm:p-8 lg:p-12 mb-8 sm:mb-12 lg:mb-16 backdrop-blur-xl bg-white/5 dark:bg-black/5 border border-brand-yellow/20 shadow-2xl">
              ...
              {/* Mobile Steps - UX Mega Ultra Otimizado */}
              <div className="sm:hidden space-y-4">
                {[
                  { step: 1, title: 'Diagnóstico', description: 'Analisamos o dispositivo', icon: <Search className="w-7 h-7" /> },
                  { step: 2, title: 'Orçamento', description: 'Valor e prazo', icon: <FileText className="w-7 h-7" /> },
                  { step: 3, title: 'Pagamento', description: 'Confirmação segura', icon: <CreditCard className="w-7 h-7" /> },
                  { step: 4, title: 'Serviço', description: 'Execução profissional', icon: <RefreshCw className="w-7 h-7" /> },
                  { step: 5, title: 'Entrega', description: 'Dispositivo pronto', icon: <CheckCircle className="w-7 h-7" /> }
                ].map((item, index) => (
                  <div
                    key={index}
                    className="bg-white/98 backdrop-blur-2xl rounded-[1.5rem] shadow-2xl p-5 flex items-center gap-5 border-[3px] border-brand-yellow/40 transform transition-all duration-150 ease-out active:scale-[0.97] active:shadow-lg active:brightness-95 cursor-pointer animate-fade-in group touch-manipulation will-change-transform"
                    style={{ animationDelay: `${0.1 + index * 0.08}s` }}
                  >
                    <div className="w-[4.5rem] h-[4.5rem] bg-gradient-to-br from-brand-yellow to-accent-light rounded-2xl flex items-center justify-center shadow-2xl group-hover:scale-110 group-active:scale-90 transition-transform duration-150 ease-out will-change-transform flex-shrink-0">
                      <span className="text-white drop-shadow-lg font-extrabold text-2xl">{item.step}</span>
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="font-extrabold text-lg text-gray-900 tracking-tight">{item.title}</h3>
                      <p className="text-base text-gray-600 mt-0.5 font-medium leading-tight">{item.description}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="hidden sm:block space-y-3 sm:space-y-4">
                {[
                  { step: 1, title: 'Diagnóstico', description: 'Analisamos o dispositivo e identificamos o problema' },
                  { step: 2, title: 'Orçamento', description: 'Apresentamos o valor e prazo para o serviço' },
                  { step: 3, title: 'Pagamento', description: 'Confirmação mediante pagamento seguro' },
                  { step: 4, title: 'Serviço', description: 'Executamos o serviço com ferramentas profissionais' },
                  { step: 5, title: 'Entrega', description: 'Dispositivo pronto e testado para você' }
                ].map((item, index) => (
                  <div
                    key={index}
            ...
            {/* Pagamento - Botão Inteligente - Mobile First - UX Mega Ultra Otimizado */}
            <div className="liquid-card rounded-[24px] sm:rounded-[32px] lg:rounded-[48px] p-4 xs:p-6 sm:p-8 lg:p-12 mb-8 sm:mb-12 lg:mb-16 backdrop-blur-xl bg-white/5 dark:bg-black/5 border border-white/10 shadow-2xl">
              {/* Mobile Header - UX Mega Ultra */}
              <div className="sm:hidden text-center mb-6">
                <div className="w-[5.5rem] h-[5.5rem] bg-gradient-to-br from-primary to-brand-green rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-2xl">
                  <CreditCard className="w-11 h-11 text-white drop-shadow-lg" />
                </div>
              ...
              {/* Desktop Header */}
              <h2 className="hidden sm:block text-lg xs:text-xl sm:text-2xl lg:text-3xl font-bold text-foreground mb-4 sm:mb-6 lg:mb-8 text-center">
                <span className="bg-gradient-to-r from-primary to-brand-green bg-clip-text text-transparent font-black">
                  💳 Pagamento
                </span>
              </h2>
              
              {/* Mobile Info Card - UX Mega Ultra Otimizado */}
              <div className="sm:hidden bg-white/98 backdrop-blur-2xl rounded-[1.75rem] shadow-2xl p-6 border-[3px] border-primary/40 mb-6">
                <p className="text-base text-gray-800 text-center font-medium leading-relaxed mb-3">
                  O pagamento ativa <strong className="text-primary">ferramentas específicas</strong> conforme o serviço.
                </p>
              ...
              {/* Desktop Info */}
              <div className="hidden sm:block bg-gradient-to-r from-primary/10 via-brand-green/5 to-transparent backdrop-blur-lg rounded-[20px] sm:rounded-[24px] lg:rounded-[32px] p-4 sm:p-6 lg:p-8 border border-primary/30 mb-4 sm:mb-6 lg:mb-8 text-center">
                <p className="text-muted-foreground text-sm sm:text-base lg:text-lg mb-3 sm:mb-4">
                  <strong>O pagamento ativa ferramentas específicas conforme o serviço solicitado.</strong>
                </p>
              ...
              {/* Mobile Métodos de Pagamento - UX Mega Ultra */}
              <div className="sm:hidden mb-6">
                <h3 className="text-base font-bold text-center mb-4 text-gray-700">Métodos:</h3>
                <div className="flex justify-center gap-3">
                  {['Carteira', 'Cartão', 'PayPal'].map((method, index) => (
                    <div
                      key={index}
                      className="bg-white/98 backdrop-blur-2xl rounded-2xl shadow-xl px-5 py-3 border-2 border-gray-200/50 transform transition-all duration-150 ease-out active:scale-[0.92] active:shadow-lg cursor-pointer touch-manipulation will-change-transform"
                    >
                      <span className="text-sm font-bold text-gray-800">{method}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Desktop Métodos */}
              <h3 className="hidden sm:block text-sm sm:text-base lg:text-lg font-bold text-center mb-3 sm:mb-4 text-muted-foreground">Métodos:</h3>
              ...
              {!isPaymentAuthorized ? (
                <div className="text-center">
                  {/* Mobile Locked State - UX Mega Ultra Otimizado */}
                  <div className="sm:hidden bg-white/98 backdrop-blur-2xl rounded-[1.75rem] shadow-2xl p-6 border-[3px] border-amber-400/50">
                    <div className="w-[5rem] h-[5rem] bg-gradient-to-br from-amber-400 to-amber-500 rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-2xl">
                      <LockKeyhole className="w-10 h-10 text-white drop-shadow-lg" />
                    </div>
                    <h3 className="text-lg font-extrabold text-amber-600 text-center mb-3">
                      Pagamento autorizado via WhatsApp
                    </h3>
                    ...
                    <Button
                      onClick={handleContact}
                      className="w-full rounded-[1.5rem] py-5 px-8 font-extrabold transition-all duration-150 ease-out bg-gradient-to-r from-primary to-brand-green hover:from-primary-darker hover:to-brand-green text-white shadow-2xl hover:shadow-primary/40 active:scale-[0.92] active:shadow-lg h-[4rem] text-lg relative overflow-hidden group touch-manipulation will-change-transform"
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/15 to-white/0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-in-out"></div>
                  ...
                  <div className="hidden sm:block bg-gradient-to-r from-amber-500/20 via-yellow-500/10 to-amber-500/20 backdrop-blur-lg rounded-[20px] sm:rounded-[24px] lg:rounded-[32px] p-4 sm:p-6 lg:p-8 border border-amber-300/30">
                ...
                <div className="text-center">
                  {/* Mobile Authorized State - UX Mega Ultra Otimizado */}
                  <div className="sm:hidden bg-white/98 backdrop-blur-2xl rounded-[1.75rem] shadow-2xl p-6 border-[3px] border-green-400/50">
                    <div className="w-[5rem] h-[5rem] bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-2xl">
                      <CheckCircle className="w-10 h-10 text-white drop-shadow-lg" />
                    </div>
                    <h3 className="text-lg font-extrabold text-green-600 text-center mb-3">
                    ...
                    <Button
                      ...
                      className="w-full rounded-[1.5rem] py-5 px-8 font-extrabold transition-all duration-150 ease-out bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white shadow-2xl hover:shadow-green-500/40 active:scale-[0.92] active:shadow-lg h-[4rem] text-lg relative overflow-hidden group touch-manipulation will-change-transform"
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/15 to-white/0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-in-out"></div>
                  ...
                  {/* Desktop Authorized State */}
                  <div className="hidden sm:block bg-gradient-to-r from-green-500/20 via-emerald-500/10 to-green-500/20 backdrop-blur-lg rounded-[20px] sm:rounded-[24px] lg:rounded-[32px] p-4 sm:p-6 lg:p-8 border border-green-300/30">
                    <div className="flex items-center justify-center space-x-2 mb-3 sm:mb-4">
                    ...
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/10 to-white/0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-in-out"></div>
                      <span className="relative z-10">Efetuar Pagamento do Serviço GSM</span>
                    </Button>
                  </div>
                </div>
              )}
            ...
            {/* CTA Final - Mobile First - UX Mega Ultra Otimizado */}
            <div className="liquid-card rounded-[24px] sm:rounded-[32px] lg:rounded-[48px] overflow-hidden backdrop-blur-xl bg-gradient-to-br from-primary/5 via-brand-green/5 to-brand-yellow/5 border border-primary/20 shadow-2xl">
              {/* Mobile CTA - UX Mega Ultra Otimizado */}
              <div className="sm:hidden p-6">
                <div className="bg-brand-dark/95 backdrop-blur-lg rounded-[2rem] p-7 border-2 border-white/30 shadow-2xl text-center mb-6">
                  ...
                  {!isPaymentAuthorized && (
                    <p className="text-base text-white/90 leading-relaxed">
                      Fale com a Tchova para diagnosticar seu dispositivo.
                    </p>
                  )}
                </div>
                ...
                <Button
                  onClick={handleContact}
                  className="w-full rounded-[1.75rem] py-6 px-10 font-extrabold transition-all duration-150 ease-out bg-gradient-to-r from-primary via-brand-green to-brand-yellow hover:from-primary-darker hover:to-brand-yellow text-white shadow-2xl hover:shadow-primary/40 active:scale-[0.92] active:shadow-lg h-[4.5rem] text-xl relative overflow-hidden group touch-manipulation will-change-transform border-2 border-white/20"
                >
                  ...
                  <span className="relative z-10 tracking-tight">Falar com a Tchova</span>
                </Button>
                ...
                {!isPaymentAuthorized && (
                  <div className="mt-5 flex items-center justify-center gap-2">
                    ...
                    <span className="text-sm text-gray-600 font-medium">
                      Pagamento liberado após conversa
                    </span>
                  </div>
                )}
              </div>
              ...
              {/* Desktop CTA */}
              <div className="hidden sm:block bg-gradient-to-r from-primary/15 to-brand-green/15 p-4 xs:p-6 sm:p-8 lg:p-12 border-b border-white/20">
                <h2 className="text-lg xs:text-xl sm:text-2xl lg:text-4xl font-black text-foreground text-center mb-2 sm:mb-4 lg:mb-6">
                  {!isPaymentAuthorized ? 'Pronto para resolver seu problema GSM?' : 'Seu serviço GSM está a caminho!'}
                </h2>
                {!isPaymentAuthorized && (
                  <p className="text-muted-foreground text-center text-xs sm:text-sm lg:text-base leading-relaxed max-w-2xl mx-auto">
                    Fale com a Tchova para diagnosticar seu dispositivo e receber um orçamento personalizado.
                  </p>
                )}
              </div>

              <div className="hidden sm:block p-4 xs:p-6 sm:p-8 lg:p-12 space-y-4 sm:space-y-6 lg:space-y-8">
